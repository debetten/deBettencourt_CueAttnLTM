...
%function settings = EEG_Settings
%
%This function specifies the settings for the preprocessing functions
%
% Written by JJF, edited by MdB 6/2017
...
% settings.dir.processed_data_path = ['F:\UC Artifact Rejection\JJF_EB_16_7\Preprocessed_Data\']; % where to save preprocessed files
...
settings.seg.arfPostTime = 1200; % msec post timelock (600 ms after array onset)
