function combine_eeg_eye_restructure(subj_name,eye_track)
...
fname_eye = [subj_name,'_EYE_SEG.mat'];
fname_eeg = [subj_name '_EEG_SEG.mat'];

% name of restructured file to be saved
fname_restruct = [eegData_dir,'/',(subj_name),'_Restruct.mat'];
